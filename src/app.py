...
activities = {
    ...
    "Basketball Team": {
        "description": "Join our competitive basketball team and develop advanced skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Play soccer and participate in friendly matches",
    ...
    "Music Band": {
        "description": "Join our school band and learn musical instruments",
...
# Novo endpoint para remoção de participante
